...
{
    public class ProductGpsProcessStateMap : EntityTypeConfiguration<ProductGpsProcessState>
    {
        public ProductGpsProcessStateMap()
        {
            // Primary Key
            HasKey(t => t.Id);
            ...
            ToTable("product_gps_process_state");
