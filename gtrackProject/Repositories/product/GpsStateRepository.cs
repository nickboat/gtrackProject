...
namespace gtrackProject.Repositories.product
{
    public class GpsStateRepository : IGpsStateRepository
    {
        ...
        public async Task<ProductGpsProcessState> Add(ProductGpsProcessState item)
        {
            if (await NameExist(item.StatusNameTh,item.StatusNameEn)) return null;

            var newType = new ProductGpsProcessState()
            {
        ...
        public async Task<bool> Update(ProductGpsProcessState item)
        {
