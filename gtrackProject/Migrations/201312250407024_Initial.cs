    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        CurrentUser = c.Int(),
                        HeadInstall = c.Int(nullable: false),
                        HD = c.String(nullable: false, maxLength: 2, fixedLength: true),
                        Version = c.Byte(),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        CreateBy = c.Short(nullable: false),
                        CreateDate = c.DateTime(nullable: false),
                        StockBy = c.Short(),
                ...
                .ForeignKey("dbo.user_profile", t => t.BadBy)
                .ForeignKey("dbo.user_profile", t => t.CreateBy, cascadeDelete: true)
                .ForeignKey("dbo.user_profile", t => t.InstallBy)
                .ForeignKey("dbo.user_profile", t => t.QCBy)
                .ForeignKey("dbo.user_profile", t => t.StockBy)
                .ForeignKey("dbo.user_profile", t => t.UnuseableBy)
                .Index(t => t.Status_Id)
                .Index(t => t.Version)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.product_gps", "UnuseableBy", "dbo.user_profile");
            DropForeignKey("dbo.product_gps", "StockBy", "dbo.user_profile");
            DropForeignKey("dbo.product_gps", "QCBy", "dbo.user_profile");
            DropForeignKey("dbo.product_gps", "InstallBy", "dbo.user_profile");
            DropForeignKey("dbo.product_gps", "CreateBy", "dbo.user_profile");
            DropForeignKey("dbo.product_gps", "BadBy", "dbo.user_profile");
            DropForeignKey("dbo.user_profile", "HD_Id", "dbo.hds");
            ...
            DropIndex("dbo.user_profile", new[] { "HD_Id" });
