    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.employee", t => t.HeadInstall)
                .ForeignKey("dbo.hds", t => t.Hd_id)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.un_cm_signal", t => t.CM_SignalStatus)
                .ForeignKey("dbo.un_cm_temp", t => t.CM_Temp)
                .ForeignKey("dbo.un_display_status", t => t.Display_Status)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.driver_category", t => t.Category_Id)
                ...
                c => new
                    {
                        ...
                        Status_Id = c.Byte(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                ...
                c => new
                    {
                        Id = c.Byte(nullable: false),
                        Name = c.String(nullable: false, maxLength: 20),
                        Meaning = c.String(nullable: false, maxLength: 255),
                    })
                .PrimaryKey(t => t.Id);
        ...
        {
            DropForeignKey("dbo.customer", "Hd_Id", "dbo.hds");
            ...
            DropIndex("dbo.customer", new[] { "Hd_Id" });
